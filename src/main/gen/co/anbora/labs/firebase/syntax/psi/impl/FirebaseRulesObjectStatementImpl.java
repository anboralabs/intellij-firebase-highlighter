...
public class FirebaseRulesObjectStatementImpl extends ASTWrapperPsiElement implements FirebaseRulesObjectStatement {

  public FirebaseRulesObjectStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
