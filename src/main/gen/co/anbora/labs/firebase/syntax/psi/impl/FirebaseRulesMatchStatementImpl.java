...
public class FirebaseRulesMatchStatementImpl
    extends ASTWrapperPsiElement implements FirebaseRulesMatchStatement {

  public FirebaseRulesMatchStatementImpl(@NotNull ASTNode node) { super(node); }
  ...
  public List<FirebaseRulesAllowStatement> getAllowStatementList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(
        this, FirebaseRulesAllowStatement.class);
  }
  ...
  public List<FirebaseRulesFunctionStatement> getFunctionStatementList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(
        this, FirebaseRulesFunctionStatement.class);
  }
  ...
  public List<FirebaseRulesMatchStatement> getMatchStatementList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(
        this, FirebaseRulesMatchStatement.class);
  }
}
