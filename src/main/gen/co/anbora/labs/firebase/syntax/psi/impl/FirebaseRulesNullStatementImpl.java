...
public class FirebaseRulesNullStatementImpl
    extends ASTWrapperPsiElement implements FirebaseRulesNullStatement {

  public FirebaseRulesNullStatementImpl(@NotNull ASTNode node) { super(node); }
