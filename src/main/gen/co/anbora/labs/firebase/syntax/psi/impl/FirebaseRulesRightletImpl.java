...
public class FirebaseRulesRightletImpl extends ASTWrapperPsiElement implements FirebaseRulesRightlet {

  public FirebaseRulesRightletImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FirebaseRulesVisitor visitor) {
    visitor.visitRightlet(this);
  }
