...
public class FirebaseRulesPathStatementImpl
    extends ASTWrapperPsiElement implements FirebaseRulesPathStatement {

  public FirebaseRulesPathStatementImpl(@NotNull ASTNode node) { super(node); }
