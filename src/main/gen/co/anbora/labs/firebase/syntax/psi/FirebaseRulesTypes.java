...
public interface FirebaseRulesTypes {
  ...
  IElementType ALLOW_STATEMENT =
      new FirebaseRulesElementType("ALLOW_STATEMENT");
  IElementType BOOLEAN_OPERATOR =
      new FirebaseRulesElementType("BOOLEAN_OPERATOR");
  IElementType BOOLEAN_STATEMENT =
      new FirebaseRulesElementType("BOOLEAN_STATEMENT");
  IElementType CALL_FUNCTION_STATEMENT =
      new FirebaseRulesElementType("CALL_FUNCTION_STATEMENT");
  IElementType CONDITIONAL_EXPRESSION =
      new FirebaseRulesElementType("CONDITIONAL_EXPRESSION");
  IElementType CONDITIONAL_STATEMENT =
      new FirebaseRulesElementType("CONDITIONAL_STATEMENT");
  IElementType EXPRESSION = new FirebaseRulesElementType("EXPRESSION");
  IElementType FULL_PATH_STATEMENT =
      new FirebaseRulesElementType("FULL_PATH_STATEMENT");
  IElementType FUNCTION_PARAMETER_STATEMENT =
      new FirebaseRulesElementType("FUNCTION_PARAMETER_STATEMENT");
  IElementType FUNCTION_STATEMENT =
      new FirebaseRulesElementType("FUNCTION_STATEMENT");
  IElementType LITERAL_STATEMENT =
      new FirebaseRulesElementType("LITERAL_STATEMENT");
  IElementType MATCH_STATEMENT =
      new FirebaseRulesElementType("MATCH_STATEMENT");
  IElementType NULL_STATEMENT = new FirebaseRulesElementType("NULL_STATEMENT");
  IElementType OBJECT_STATEMENT =
      new FirebaseRulesElementType("OBJECT_STATEMENT");
  IElementType PARAMETER_STATEMENT =
      new FirebaseRulesElementType("PARAMETER_STATEMENT");
  IElementType PATH_STATEMENT = new FirebaseRulesElementType("PATH_STATEMENT");
  IElementType PERMISSION_STATEMENT =
      new FirebaseRulesElementType("PERMISSION_STATEMENT");
  IElementType PROPERTY = new FirebaseRulesElementType("PROPERTY");
  IElementType RETURN_STATEMENT =
      new FirebaseRulesElementType("RETURN_STATEMENT");
  IElementType RULE_VERSION_STATEMENT =
      new FirebaseRulesElementType("RULE_VERSION_STATEMENT");
  IElementType SERVICE_STATEMENT =
      new FirebaseRulesElementType("SERVICE_STATEMENT");
  ...
  IElementType FUNCTION_KEYWORD =
      new FirebaseRulesTokenType("FUNCTION_KEYWORD");
