...
public class FirebaseRulesComponentImpl extends ASTWrapperPsiElement implements FirebaseRulesComponent {

  public FirebaseRulesComponentImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public FirebaseRulesMetadata getMetadata() {
    return findChildByClass(FirebaseRulesMetadata.class);
  }

  @Override
  @Nullable
  public PsiElement getNodename() {
    return findChildByType(NODENAME);
  }
