...
public class FirebaseRulesReturnStatementImpl extends ASTWrapperPsiElement implements FirebaseRulesReturnStatement {

  public FirebaseRulesReturnStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
